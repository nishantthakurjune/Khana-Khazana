    ...
    <div>
      ...
      <div className="mb-5">
        <div className="flex flex-col justify-center items-center gap-5 pb-5">
          ...
          <div className="bg-gray-100 flex w-9/12 gap-10 justify-center items-center px-5 py-5">
            <button
        ...
        <div className="flex flex-col md:mt-32 lg:mt-52 px-5 ml-5">
          <div className="flex flex-col justify-center items-center">
            <h3 className="text-3xl font-semibold">
              Why <b className="text-red-600">Khana Khazana</b>?
            </h3>
            <p className="text-sm">
              <span className="text-red-500">Khana Khazana</span> is a revolutionary
