      ...
      <div className="flex flex-col  justify-center items-center gap-5">
        <div className="">
          <h3 className="text-3xl font-semibold mb-2">
            Your <b className="text-red-500">Favorite</b> Dishes,
          </h3>
          <h3 className="text-2xl text-center">
            Just a <b className="text-red-500">Click</b> Away
          </h3>
        </div>
        <div className="text-center">
          <p>Delicious Meals, Delivered to Your Doorste.</p>
          <p>
            No more waiting in long lines. Get your favorite meals delivered in
            no time, hassle-free.
          </p>
        </div>
      </div>
